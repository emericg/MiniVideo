...
static const uint8_t wave_guid[4][8] =
{
    {0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71},   // GUIDBASE
    {0x86, 0x44, 0xC8, 0xC1, 0xCA, 0x00, 0x00, 0x00},   // AMBISONIC_SUBTYPE_PCM
    {0x86, 0x44, 0xC8, 0xC1, 0xCA, 0x00, 0x00, 0x00},   // AMBISONIC_SUBTYPE_IEEE_FLOAT
    {0xA1, 0x19, 0xFF, 0xFA, 0x01, 0xE4, 0xCE, 0x62}    // ATRAC3P
};
